...
function of_recognized_background_repeat() {
	$default = array(
		...
		'repeat-x'  => __( 'Repeat Horizontally', 'alchem' ),
		'repeat-y'  => __( 'Repeat Vertically', 'alchem' ),
		'repeat'    => __( 'Repeat All', 'alchem' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		...
		'center left'   => __( 'Middle Left', 'alchem' ),
		'center center' => __( 'Middle Center', 'alchem' ),
		'center right'  => __( 'Middle Right', 'alchem' ),
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'alchem' ),
		'fixed'  => __( 'Fixed in Place', 'alchem')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'alchem' ),
		'italic'      => __( 'Italic', 'alchem' ),
		'bold'        => __( 'Bold', 'alchem' ),
		'bold italic' => __( 'Bold Italic', 'alchem' )
		);
